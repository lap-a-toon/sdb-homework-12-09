# Домашнее задание к занятию 12.09. «Базы данных в облаке» - Лабазов Александр
## Скриншоты в конце документа
...
![isMaster & gotDataBase](./images/master-1.jpg)

![created table, inserted data](./images/master-2.jpg)

*2) Результата вывода команды на реплике ```select * from test_table;```.*

![check data on replica](./images/replica-1.jpg)
